...
import { Trophy, Zap, GraduationCap, Cog, Building, Shield, Calendar } from "lucide-react";
...
export const WhyMeSection = () => {
  ...
  return (
    <section id="why-me" className="relative min-h-screen responsive-py-lg mobile-safe-area overflow-hidden bg-background">
      {/* Background Effects */}
      ...
      <div className="container-responsive max-w-7xl relative z-10">
        ...
        >
          <motion.h2 
            ...
            viewport={{ once: true }}
          >
            Why Leaders <span className="text-transparent bg-gradient-to-r from-primary via-accent to-primary bg-clip-text">Trust</span> <span className="text-white">Me</span>?
          </motion.h2>
          <motion.p 
                    ...
                    <div className="space-y-3 lg:space-y-4 flex-grow flex flex-col">
                      ...
                      <div className="space-y-2 mt-auto">
                        {item.points.map((point, pointIndex) => (
                          <div key={pointIndex} className="flex items-start responsive-text-sm">
